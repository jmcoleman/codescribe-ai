          ...
          - code [ref=e69]:
            - generic [ref=e70]:
              - generic [ref=e72]:
                ...
                - generic [ref=e88]: "7"
              - generic [ref=e101]:
                - generic [ref=e103]: "class MyClass { constructor() {} }// Paste your code here or try the example below..."
                ...
                - generic [ref=e112]: "}"
              - textbox "Editor content" [active] [ref=e116]: "class MyClass { constructor() {} }// Paste your code here or try the example below... // Example function: function calculateTotal(items) { return items.reduce((sum, item) => sum + item.price, 0); }"
          - generic [ref=e117]:
            - generic [ref=e118]: 7 lines • 202 chars
            - generic [ref=e119]:
              - img [ref=e120]
