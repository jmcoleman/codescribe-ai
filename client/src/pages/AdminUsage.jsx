...
export default function AdminUsage() {
  ...
  const [userTypeFilter, setUserTypeFilter] = useState('all'); // 'all', 'anonymous', 'authenticated'
  ...
  return (
    <PageLayout showGradient={false} className="bg-gradient-to-b from-slate-50 to-white dark:from-slate-900 dark:to-slate-950">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 pb-12">
        ...
        {/* Main Stats - Changes based on filter */}
        <div className="transition-opacity duration-200 ease-in-out" key={userTypeFilter}>
        {userTypeFilter === 'all' ? (
          <>
            {/* Overall Summary */}
