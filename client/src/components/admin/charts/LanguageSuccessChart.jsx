/**
 * LanguageSuccessChart Component
 ...
 * LanguageSuccessChart Component
 * @param {Object} props
 * @param {Array} props.data - Array of { language, successful, failed, total, successRate } objects
 * @param {boolean} props.isDark - Whether dark mode is active
 * @param {number} props.height - Chart height in pixels
 */
export default function LanguageSuccessChart({
  data,
  isDark = false,
  height = 300,
}) {
