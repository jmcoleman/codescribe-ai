        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-3 pt-2 border-t border-slate-200">
            ...
            <button
              type="button"
              onClick={onUpgrade}
              className="flex-shrink-0 inline-flex items-center gap-1.5 px-4 py-2 bg-purple-600 hover:bg-purple-700 active:bg-purple-800 text-white text-sm font-semibold rounded-lg transition-all duration-200 shadow-sm hover:shadow focus:outline-none focus:ring-2 focus:ring-purple-600 focus:ring-offset-2"
            >
              Upgrade
