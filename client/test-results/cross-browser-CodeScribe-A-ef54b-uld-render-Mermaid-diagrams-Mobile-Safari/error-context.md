        ...
        - generic [ref=e40]:
          ...
          - code [ref=e60]:
            - generic [ref=e61]:
              ...
              - textbox "Editor content" [active] [ref=e78]: "class MyClass { constructor() {} }// Paste your code here or try the example below... // Example function: function calculateTotal(items) { return items.reduce((sum, item) => sum + item.price, 0); }"
          - generic [ref=e79]:
